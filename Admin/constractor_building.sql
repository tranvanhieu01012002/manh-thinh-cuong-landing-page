...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2022 at 07:10 AM
...
(31, 'Dự án 1', '001', 300, 200, 'Lê Văn Sỹ', '0987654321', 'Lê Tiến', 'Đồng Lê ', 'Tuyên Hóa', 'nhao', '12/1/2022', '1/1/2022', 'images (4).jpg', 'Rất là đẹp có điều giá hơi mắc', 'Một siêu phẩm của Tập Đoàn Hưng Thịnh đã xuất hiện tại Bình Dương. Với lối kiến trúc hiện đại thân thiện với môi trường hài hòa với thiên nhiên. Dự án căn hộ New Galaxy Hưng Thịnh Dĩ An Bình Dương Làng Đại Học, mỗi căn hộ tại đây được trau chuốt tỉ mỉ đến từng centimet thể hiện một phong cách hết sức độc đáo và sang trọng…  Đặc biệt căn hộ New Galaxy Hưng Thịnh Bình Dương đây là cơ hội thật sự cho những người thu nhập trung bình biến ước mơ, mong muốn có được một căn hộ như ý thành hiện thực.', 'yes'),
(32, 'Dự án 2', '002', 400, 200, 'Lê Văn Sỹ', '0987654321', 'Lê Tiến', 'Đồng Lê ', 'Tuyên Hóa', 'nhavuon', '1/1/2022', '2022/1/1', 'slides5.jpg', 'Khu nhà ven biển cao cấp', 'Vai trò của học sinh trong thực hiện dự án Nhà nghiên cứu khoa học Lập trình viên thiết Sắm Phóng viên kế đồ họa vai Nhà quản lý môi trường', 'no'),
(33, 'Dự án 3', '003', 400, 200, 'Lê Văn Sỹ', '0987654321', 'Lê Tiến', 'Đồng Lê ', 'Tuyên Hóa', 'nhao', '1/1/2022', '2022/1/1', 'images (2).jpg', 'Khu nhà ven biển cao cấp', 'Vai trò của học sinh trong thực hiện dự án Nhà nghiên cứu khoa học Lập trình viên thiết Sắm Phóng viên kế đồ họa vai Nhà quản lý môi trường', 'yes'),
...
--
ALTER TABLE `project`
  MODIFY `id_project` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
