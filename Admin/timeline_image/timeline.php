  ...
  <ul class="responsive-table">
    ...
    <?php   
        ...
        <?php foreach($row as $value):?>
          <li class="table-row">
          <div class="col col-2"><img width="100%" src="../img/<?php echo $value['img_1'] ?>" alt=""></div>
          <div class="col col-2"><img width="100%" src="../img/<?php echo $value['img_2'] ?>" alt=""></div>
          <div class="col col-2"><img width="100%" src="../img/<?php echo $value['img_3'] ?>" alt=""></div>
          <div class="col col-2"><img width="100%" src="../img/<?php echo $value['img_4'] ?>" alt=""></div>
          <div class="col col-2"><img width="100%" src="../img/<?php echo $value['img_5'] ?>" alt=""></div>
